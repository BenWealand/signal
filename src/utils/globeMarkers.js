...
const LOCATION_KEYWORDS = [
  ...
  { match: ["washington dc", "washington d.c.", "district of columbia", "white house", "capitol hill"], region: "Washington", location: [38.9072, -77.0369] },
  ...
  { match: ["gaza"], region: "Gaza", location: [31.5017, 34.4668] },
  { match: ["israel", "jerusalem"], region: "Jerusalem", location: [31.7683, 35.2137] },
