...
class Settings:
    ...
    article_image_search_timeout_seconds: float = float(os.getenv("SIGNAL_ARTICLE_IMAGE_TIMEOUT", "8"))
    article_image_wait_seconds: float = float(os.getenv("SIGNAL_ARTICLE_IMAGE_WAIT", "4"))
